...
BATCHES = [
    ...
    {"num": 2,  "module": "batch_02_crm_core",
     "description": "Accounts, Contacts, Contact Info"},
    {"num": 3,  "module": "batch_03_leads_products",
     "description": "Leads, Products, PriceBooks"},
    {"num": 4,  "module": "batch_04_sales",
     "description": "Opportunities, Quotes, Orders, Invoices"},
    {"num": 5,  "module": "batch_05_activities",
     "description": "Interactions, Tasks, Notes"},
    {"num": 6,  "module": "batch_06_marketing",
     "description": "Campaigns, Templates, Sequences"},
    {"num": 7,  "module": "batch_07_itsm",
     "description": "Service Desk, Incidents, Changes, KB"},
    {"num": 8,  "module": "batch_08_commissions",
     "description": "Commissions, Territories, Teams"},
    {"num": 9,  "module": "batch_09_workflows",
     "description": "Workflows, Approvals, Triggers, Rule Engine"},
    {"num": 10, "module": "batch_10_ai_analytics",
     "description": "AI Agents, SK Plugins, Analytics, Reports"},
    {"num": 11, "module": "batch_11_infrastructure",
     "description": "Monitoring, Config, MasterData"},
    {"num": 12, "module": "batch_12_misc",
     "description": "Files, Tags, CustomFields, Misc"},
    {"num": 13, "module": "batch_13_integration",
     "description": "Integration-Dependent Endpoints (probe & skip)"},
    {"num": 14, "module": "batch_14_rules_workflows",
     "description": "Rules, Rulesets & Full Workflow E2E"},
    {"num": 15, "module": "batch_15_service_desk_config",
     "description": "SR Categories, Types, SLAs, Queues, AutoAssign, Escalation"},
    {"num": 16, "module": "batch_16_master_catalog_data",
     "description": "Lead Sources, Currencies, Competitors, Master Data, Lookups"},
    {"num": 17, "module": "batch_17_subscriptions_billing",
     "description": "Subscription Lifecycle, Billing, Usage, Revenue, Dunning"},
    {"num": 18, "module": "batch_18_financial_extended",
     "description": "Credit Memos, Order Returns, Pricing Rules, Tax, Payment Methods"},
    {"num": 19, "module": "batch_19_portals_engagement",
     "description": "Portal, Partner Portal, Web-to-Lead, Landing Pages, Events, Segments"},
    {"num": 20, "module": "batch_20_comms_notifications",
     "description": "Conversations, Communications, Comments, Notifications, GDPR"},
    {"num": 21, "module": "batch_21_crm_config",
     "description": "Pipelines, Forecast, Quote Templates, ProductCat, PriceBooks, Tags"},
    {"num": 22, "module": "batch_22_admin_ops",
     "description": "Roles, API Keys, Webhooks, Imports, Exports, Admin Config, Alerts"},
    {"num": 23, "module": "batch_23_fortune100",
     "description": "Fortune 100 Companies — Accounts & Linked Contacts"},
]
