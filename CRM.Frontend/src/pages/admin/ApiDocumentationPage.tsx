...
const apiEndpoints: ApiEndpoint[] = [
  ...
  { method: 'POST', path: '/api/contacts', description: 'Create new contact', auth: true, category: 'Contacts', requestBody: '{ "firstName": "string", "lastName": "string", "email": "string", "phone": "string", "accountId": "int?" }' },
  ...
  { method: 'POST', path: '/api/opportunities', description: 'Create new opportunity', auth: true, category: 'Opportunities', requestBody: '{ "name": "string", "amount": "decimal", "probability": "int", "stage": "int", "accountId": "int" }' },
...
const webhooks: Webhook[] = [
  ...
  { event: 'opportunity.created', description: 'Fired when a new opportunity is created', category: 'Opportunity', payload: '{ "event": "opportunity.created", "timestamp": "ISO8601", "data": { "id": 1, "name": "New Deal", "amount": 50000, "stage": 1 } }' },
  ...
  { event: 'service_request.created', description: 'Fired when a service request is created', category: 'Service', payload: '{ "event": "service_request.created", "timestamp": "ISO8601", "data": { "id": 1, "title": "Support Request", "priority": "High", "accountId": 10 } }' },
