...
const apiEndpoints: ApiEndpoint[] = [
  ...
  { method: 'POST', path: '/api/opportunities', description: 'Create new opportunity', auth: true, category: 'Opportunities', requestBody: '{ "name": "string", "amount": "decimal", "probability": "int", "stage": "int", "customerId": "int" }' },
...
const webhooks: Webhook[] = [
  ...
  { event: 'lead.converted', description: 'Fired when a lead is converted to opportunity', category: 'Lead', payload: '{ "event": "lead.converted", "timestamp": "ISO8601", "data": { "leadId": 1, "opportunityId": 5, "customerId": 10 } }' },
  ...
  { event: 'opportunity.won', description: 'Fired when an opportunity is marked as won', category: 'Opportunity', payload: '{ "event": "opportunity.won", "timestamp": "ISO8601", "data": { "id": 1, "amount": 50000, "customerId": 10, "closedDate": "ISO8601" } }' },
