...
const DEFAULT_NAV_ITEMS: NavItem[] = [
  ...
  { id: 'opportunities', label: 'Opportunities', menuName: 'Opportunities', icon: 'TrendingUpIcon', order: 6, visible: true, isAdmin: false, category: 'sales' },
  { id: 'products', label: 'Products', menuName: 'Products', icon: 'PackageIcon', order: 7, visible: true, isAdmin: false, category: 'sales' },
  { id: 'services', label: 'Services', menuName: 'Services', icon: 'SettingsIcon', order: 8, visible: true, isAdmin: false, category: 'support' },
  { id: 'service-requests', label: 'Service Requests', menuName: 'ServiceRequests', icon: 'SupportAgentIcon', order: 9, visible: true, isAdmin: false, category: 'support' },
  ...
  { id: 'communications', label: 'Communications', menuName: 'Communications', icon: 'CommunicationsIcon', order: 16, visible: true, isAdmin: false, category: 'productivity' },
  { id: 'interactions', label: 'Interactions', menuName: 'Interactions', icon: 'InteractionsIcon', order: 17, visible: true, isAdmin: false, category: 'productivity' },
  // Help & Info
...
const iconMap: Record<string, React.ReactNode> = {
  ...
  CampaignExecutionIcon: <CampaignExecutionIcon />,
  AboutIcon: <AboutIcon />,
  HelpIcon: <HelpIcon />,
