...
const DEFAULT_NAV_ITEMS: NavItem[] = [
  ...
  { id: 'contacts', label: 'Contacts', menuName: 'Contacts', icon: 'PeopleIcon', order: 2, visible: true, isAdmin: false },
  { id: 'leads', label: 'Leads', menuName: 'Leads', icon: 'PeopleIcon', order: 3, visible: true, isAdmin: false },
  { id: 'opportunities', label: 'Opportunities', menuName: 'Opportunities', icon: 'TrendingUpIcon', order: 4, visible: true, isAdmin: false },
  { id: 'products', label: 'Products', menuName: 'Products', icon: 'PackageIcon', order: 5, visible: true, isAdmin: false },
  { id: 'services', label: 'Services', menuName: 'Services', icon: 'SettingsIcon', order: 6, visible: true, isAdmin: false },
  { id: 'service-requests', label: 'Service Requests', menuName: 'ServiceRequests', icon: 'SupportAgentIcon', order: 7, visible: true, isAdmin: false },
  { id: 'campaigns', label: 'Campaigns', menuName: 'Campaigns', icon: 'MegaphoneIcon', order: 8, visible: true, isAdmin: false },
  { id: 'quotes', label: 'Quotes', menuName: 'Quotes', icon: 'QuoteIcon', order: 9, visible: true, isAdmin: false },
  { id: 'tasks', label: 'Tasks', menuName: 'Tasks', icon: 'TaskIcon', order: 10, visible: true, isAdmin: false },
  { id: 'activities', label: 'Activities', menuName: 'Activities', icon: 'ActivityIcon', order: 11, visible: true, isAdmin: false },
  { id: 'notes', label: 'Notes', menuName: 'Notes', icon: 'NoteIcon', order: 12, visible: true, isAdmin: false },
  { id: 'workflows', label: 'Workflows', menuName: 'Workflows', icon: 'AutomationIcon', order: 13, visible: true, isAdmin: true },
  { id: 'settings', label: 'Admin Settings', menuName: 'Settings', icon: 'SettingsIcon', order: 14, visible: true, isAdmin: true },
];
