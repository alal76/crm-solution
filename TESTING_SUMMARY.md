...
### Test Statistics (v0.0.37 - Updated February 2026)
- **Total Unit Tests:** 1,787
- **Passed:** 1,787
- **Failed:** 0
- **Skipped:** 0
...
| **Entity (Core)** | ~1,226 | Core entity validation, business logic, enums |
...
CRM.Backend/tests/
├── Unit/
│   └── Core/                  # Isolated CRM.Core unit tests (1,609 tests)
