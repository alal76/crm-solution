...
export const COMPREHENSIVE_TEST_OPPORTUNITIES = {
  ...
  lostDeal: {
    ...
    accountId: 'TEST_CUST_CHURNED_001',
    contactId: null,
    value: 100000,
    stage: 'Closed Lost',
    probability: 0,
