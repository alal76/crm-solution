...
//
// Unit tests for Activity, Note, Tag, EntityTag, Address, and Department entities
...
public class ActivityTypeEnumTests
{
    ...
    [Fact]
    public void ActivityType_ShouldHave33Values()
    {
        Enum.GetValues(typeof(ActivityType)).Length.Should().Be(33);
    }
