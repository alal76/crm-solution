...
namespace CRM.Backend.Tests.Integration.Controllers
{
    ...
    public class AgentAdminControllerTests
    {
        ...
        [Fact]
        public async Task GetEndpoint_AgentAdmin_ReturnsNon500()
        {
            var res = await _client.GetAsync("/api/agents/admin");
            ((int)res.StatusCode).Should().BeLessThan(500, "GET /api/agents/admin should not return a server error");
        }
