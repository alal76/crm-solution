...
namespace CRM.Backend.Tests.Integration.Controllers
{
 ...
 // alias check
            ...
            var pRes = await _client.PatchAsJsonAsync($"/api/usergroups/{id}", patch);
            pRes.StatusCode.Should().Be(HttpStatusCode.OK);
            var del = await _client.DeleteAsync($"/api/usergroups/{id}");
            del.StatusCode.Should().Be(HttpStatusCode.NoContent);
            var nf = await _client.GetAsync($"/api/usergroups/{id}");
