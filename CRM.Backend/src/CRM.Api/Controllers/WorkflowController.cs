...
public class WorkflowController : CrmControllerBase
{
    ...
    {
        new() { Value = "equals", Label = "equals", AppliesTo = new[] { FieldTypeString, FieldTypeNumber, FieldTypeBoolean, FieldTypeDate } },
        new() { Value = "notEquals", Label = "does not equal", AppliesTo = new[] { FieldTypeString, FieldTypeNumber, FieldTypeBoolean, FieldTypeDate } },
        new() { Value = "contains", Label = "contains", AppliesTo = new[] { FieldTypeString } },
        new() { Value = "notContains", Label = "does not contain", AppliesTo = new[] { FieldTypeString } },
        new() { Value = "startsWith", Label = "starts with", AppliesTo = new[] { FieldTypeString } },
        new() { Value = "endsWith", Label = "ends with", AppliesTo = new[] { FieldTypeString } },
        new() { Value = "greaterThan", Label = "is greater than", AppliesTo = new[] { FieldTypeNumber, FieldTypeDate } },
        new() { Value = "lessThan", Label = "is less than", AppliesTo = new[] { FieldTypeNumber, FieldTypeDate } },
        new() { Value = "greaterThanOrEqual", Label = "is greater than or equal", AppliesTo = new[] { FieldTypeNumber, FieldTypeDate } },
        new() { Value = "lessThanOrEqual", Label = "is less than or equal", AppliesTo = new[] { FieldTypeNumber, FieldTypeDate } },
        new() { Value = "isNull", Label = "is empty", AppliesTo = new[] { FieldTypeString, FieldTypeNumber, FieldTypeDate } },
        new() { Value = "isNotNull", Label = "is not empty", AppliesTo = new[] { FieldTypeString, FieldTypeNumber, FieldTypeDate } },
        new() { Value = "in", Label = "is in list", AppliesTo = new[] { FieldTypeString, FieldTypeNumber } },
        new() { Value = "notIn", Label = "is not in list", AppliesTo = new[] { FieldTypeString, FieldTypeNumber } },
        new() { Value = "between", Label = "is between", AppliesTo = new[] { FieldTypeNumber, FieldTypeDate } },
        new() { Value = "regex", Label = "matches pattern", AppliesTo = new[] { FieldTypeString } }
    };
