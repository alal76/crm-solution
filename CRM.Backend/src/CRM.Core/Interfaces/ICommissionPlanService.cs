...
/// <summary>
/// DTO for commission plan request.
/// </summary>
public class CreateCommissionPlanDto
{
    ...
    public List<CreateCommissionTierDto> Tiers { get; set; } = new();
}
...
/// <summary>
/// DTO for commission tier request.
/// </summary>
...
/// <summary>
/// DTO for commission plan response.
/// </summary>
...
/// <summary>
/// DTO for commission tier response.
/// </summary>
