...
public static class CampaignMapper
{
    ...
    public static void UpdateEntity(MarketingCampaign entity, UpdateCampaignDto dto)
    {
        ...
        if (dto.CampaignCode != null)
            entity.CampaignCode = dto.CampaignCode;
        if (dto.Description != null)
            entity.Description = dto.Description;
        if (dto.Objective != null)
            entity.Objective = dto.Objective;
        if (dto.ObjectiveType.HasValue)
            entity.ObjectiveType = (CampaignObjective)dto.ObjectiveType.Value;
        if (dto.CampaignType.HasValue)
            entity.CampaignType = (CampaignType)dto.CampaignType.Value;
        if (dto.Priority.HasValue)
            entity.Priority = (CampaignPriority)dto.Priority.Value;
        if (dto.Status.HasValue)
            entity.Status = (CampaignStatus)dto.Status.Value;
        if (dto.Type != null)
            entity.Type = dto.Type;
        if (dto.PrimarySuccessMetric.HasValue)
            entity.PrimarySuccessMetric = (SuccessMetric)dto.PrimarySuccessMetric.Value;
        if (dto.Theme != null)
            entity.Theme = dto.Theme;
        if (dto.ValueProposition != null)
            entity.ValueProposition = dto.ValueProposition;

        // Timeline
        if (dto.StartDate != null)
            entity.StartDate = FromIso(dto.StartDate);
        if (dto.EndDate != null)
            entity.EndDate = FromIso(dto.EndDate);
        if (dto.ActualStartDate != null)
            entity.ActualStartDate = FromIso(dto.ActualStartDate);
        if (dto.ActualEndDate != null)
            entity.ActualEndDate = FromIso(dto.ActualEndDate);
        if (dto.DurationDays.HasValue)
            entity.DurationDays = dto.DurationDays;
        if (dto.IsEvergreen.HasValue)
            entity.IsEvergreen = dto.IsEvergreen.Value;
        ...
        if (dto.Budget.HasValue)
            entity.Budget = dto.Budget.Value;
        if (dto.ActualCost.HasValue)
            entity.ActualCost = dto.ActualCost.Value;
        if (dto.DailyBudget.HasValue)
            entity.DailyBudget = dto.DailyBudget;
        ...
        if (dto.ActualRevenue.HasValue)
            entity.ActualRevenue = dto.ActualRevenue;
        if (dto.CurrencyCode != null)
            entity.CurrencyCode = dto.CurrencyCode;

        // Target Audience
        if (dto.TargetAudience.HasValue)
            entity.TargetAudience = dto.TargetAudience.Value;
        if (dto.TargetAudienceDescription != null)
            entity.TargetAudienceDescription = dto.TargetAudienceDescription;
        if (dto.AudienceType.HasValue)
            entity.AudienceType = (AudienceType)dto.AudienceType.Value;
        if (dto.TargetDemographics != null)
            entity.TargetDemographics = dto.TargetDemographics;
        if (dto.TargetFirmographics != null)
            entity.TargetFirmographics = dto.TargetFirmographics;
        if (dto.TargetGeography != null)
            entity.TargetGeography = dto.TargetGeography;
        if (dto.TargetIndustries != null)
            entity.TargetIndustries = dto.TargetIndustries;
        if (dto.TargetSegments != null)
            entity.TargetSegments = dto.TargetSegments;
        if (dto.TargetPersonas != null)
            entity.TargetPersonas = dto.TargetPersonas;
        if (dto.TargetJobTitles != null)
            entity.TargetJobTitles = dto.TargetJobTitles;
        if (dto.TargetSeniorityLevels != null)
            entity.TargetSeniorityLevels = dto.TargetSeniorityLevels;
        if (dto.TargetAccounts != null)
            entity.TargetAccounts = dto.TargetAccounts;
        if (dto.ExclusionCriteria != null)
            entity.ExclusionCriteria = dto.ExclusionCriteria;
        if (dto.SuppressionLists != null)
            entity.SuppressionLists = dto.SuppressionLists;
        if (dto.AudienceListId != null)
            entity.AudienceListId = dto.AudienceListId;

        // Content & Creative
        if (dto.MessageSubject != null)
            entity.MessageSubject = dto.MessageSubject;
        if (dto.PreheaderText != null)
            entity.PreheaderText = dto.PreheaderText;
        ...
        if (dto.ReplyToEmail != null)
            entity.ReplyToEmail = dto.ReplyToEmail;
        if (dto.CallToAction != null)
            entity.CallToAction = dto.CallToAction;
        if (dto.CtaUrl != null)
            entity.CtaUrl = dto.CtaUrl;
        if (dto.LandingPageUrl != null)
            entity.LandingPageUrl = dto.LandingPageUrl;
        if (dto.TrackingUrl != null)
            entity.TrackingUrl = dto.TrackingUrl;
        if (dto.CreativeAssets != null)
            entity.CreativeAssets = dto.CreativeAssets;
        if (dto.TemplateId != null)
            entity.TemplateId = dto.TemplateId;

        // UTM Tracking
        if (dto.UtmSource != null)
            entity.UtmSource = dto.UtmSource;
        if (dto.UtmMedium != null)
            entity.UtmMedium = dto.UtmMedium;
        if (dto.UtmCampaign != null)
            entity.UtmCampaign = dto.UtmCampaign;
        if (dto.UtmContent != null)
            entity.UtmContent = dto.UtmContent;
        if (dto.UtmTerm != null)
            entity.UtmTerm = dto.UtmTerm;

        // A/B Testing
        if (dto.IsABTest.HasValue)
            entity.IsABTest = dto.IsABTest.Value;
        if (dto.ABTestVariants != null)
            entity.ABTestVariants = dto.ABTestVariants;
        if (dto.ABTestMetric != null)
            entity.ABTestMetric = dto.ABTestMetric;
        if (dto.WinningVariant != null)
            entity.WinningVariant = dto.WinningVariant;
        ...
        if (dto.SocialNetworks != null)
            entity.SocialNetworks = dto.SocialNetworks;
        if (dto.AdPlatforms != null)
            entity.AdPlatforms = dto.AdPlatforms;
        if (dto.ExternalCampaignIds != null)
            entity.ExternalCampaignIds = dto.ExternalCampaignIds;
        ...
        // Campaign Hierarchy
        if (dto.ParentCampaignId.HasValue)
            entity.ParentCampaignId = dto.ParentCampaignId;
        if (dto.RelatedCampaigns != null)
            entity.RelatedCampaigns = dto.RelatedCampaigns;
        if (dto.Program != null)
            entity.Program = dto.Program;
        if (dto.Initiative != null)
            entity.Initiative = dto.Initiative;
        if (dto.FiscalQuarter != null)
        ...
        // ROI Targets
        if (dto.TargetRoi.HasValue)
            entity.TargetRoi = dto.TargetRoi;
        if (dto.TargetLeads.HasValue)
            entity.TargetLeads = dto.TargetLeads;
        if (dto.TargetConversions.HasValue)
            entity.TargetConversions = dto.TargetConversions;
        ...
        if (dto.BriefUrl != null)
            entity.BriefUrl = dto.BriefUrl;
        if (dto.ReportUrl != null)
            entity.ReportUrl = dto.ReportUrl;
        ...
        if (dto.SyncStatus != null)
            entity.SyncStatus = dto.SyncStatus;

        // Event / Webinar
        if (dto.EventCapacity.HasValue)
            entity.EventCapacity = dto.EventCapacity;
        if (dto.EventLocation != null)
            entity.EventLocation = dto.EventLocation;
        if (dto.EventDateTime != null)
            entity.EventDateTime = FromIso(dto.EventDateTime);
        if (dto.WebinarPlatform != null)
            entity.WebinarPlatform = dto.WebinarPlatform;
        if (dto.WebinarRecordingUrl != null)
            entity.WebinarRecordingUrl = dto.WebinarRecordingUrl;

        // Paid Advertising
        if (dto.Keywords != null)
            entity.Keywords = dto.Keywords;
        if (dto.NegativeKeywords != null)
            entity.NegativeKeywords = dto.NegativeKeywords;
        if (dto.AdSpend.HasValue)
            entity.AdSpend = dto.AdSpend;
        if (dto.CostPerClick.HasValue)
            entity.CostPerClick = dto.CostPerClick;
        if (dto.CostPerMille.HasValue)
            entity.CostPerMille = dto.CostPerMille;
        if (dto.Roas.HasValue)
            entity.Roas = dto.Roas;

        // Metrics that can be manually set
        if (dto.LeadsGenerated.HasValue)
            entity.LeadsGenerated = dto.LeadsGenerated.Value;
        if (dto.MqlsGenerated.HasValue)
            entity.MqlsGenerated = dto.MqlsGenerated.Value;
        if (dto.SqlsGenerated.HasValue)
            entity.SqlsGenerated = dto.SqlsGenerated.Value;
        if (dto.SalsGenerated.HasValue)
            entity.SalsGenerated = dto.SalsGenerated.Value;
        if (dto.OpportunitiesCreated.HasValue)
            entity.OpportunitiesCreated = dto.OpportunitiesCreated.Value;
        if (dto.OpportunitiesInfluenced.HasValue)
            entity.OpportunitiesInfluenced = dto.OpportunitiesInfluenced.Value;
        if (dto.DealsWon.HasValue)
            entity.DealsWon = dto.DealsWon.Value;
        if (dto.AccountsAcquired.HasValue)
            entity.AccountsAcquired = dto.AccountsAcquired.Value;
        if (dto.Impressions.HasValue)
            entity.Impressions = dto.Impressions.Value;
        if (dto.Reach.HasValue)
            entity.Reach = dto.Reach.Value;
        if (dto.Clicks.HasValue)
            entity.Clicks = dto.Clicks.Value;
        if (dto.EmailsSent.HasValue)
            entity.EmailsSent = dto.EmailsSent.Value;
        if (dto.EmailsDelivered.HasValue)
            entity.EmailsDelivered = dto.EmailsDelivered.Value;
        if (dto.EmailsOpened.HasValue)
            entity.EmailsOpened = dto.EmailsOpened.Value;
        if (dto.EmailClicks.HasValue)
            entity.EmailClicks = dto.EmailClicks.Value;
        if (dto.HardBounces.HasValue)
            entity.HardBounces = dto.HardBounces.Value;
        if (dto.SoftBounces.HasValue)
            entity.SoftBounces = dto.SoftBounces.Value;
        if (dto.Bounces.HasValue)
            entity.Bounces = dto.Bounces.Value;
        if (dto.Unsubscribes.HasValue)
            entity.Unsubscribes = dto.Unsubscribes.Value;
        if (dto.SpamComplaints.HasValue)
            entity.SpamComplaints = dto.SpamComplaints.Value;
        if (dto.Registrations.HasValue)
            entity.Registrations = dto.Registrations.Value;
        if (dto.Attendance.HasValue)
            entity.Attendance = dto.Attendance.Value;
        if (dto.NoShows.HasValue)
            entity.NoShows = dto.NoShows.Value;
        if (dto.PipelineInfluenced.HasValue)
            entity.PipelineInfluenced = dto.PipelineInfluenced;
        if (dto.PipelineCreated.HasValue)
            entity.PipelineCreated = dto.PipelineCreated;
    }
}
