    ...
    public static async Task SeedAIAgentsAsync(CrmDbContext context, ILogger? logger = null)
    {
        ...
        var agents = new[]
        {
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.LeadScoring),
                IsActive = true,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.SupportTriage),
                IsActive = true,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.NextBestAction),
                IsActive = true,
                RequiresApproval = false,
                ApprovalTier = "auto",
                Temperature = 0.4,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.SalesIntelligence),
                IsActive = true,
                RequiresApproval = false,
                ApprovalTier = "auto",
                Temperature = 0.3,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.EmailAssistant),
                IsActive = false,
                RequiresApproval = true,
                ApprovalTier = "standard",
                Temperature = 0.7,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.CustomerSuccess),
                IsActive = false,
                RequiresApproval = true,
                ApprovalTier = "standard",
                Temperature = 0.3,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.RevenueIntelligence),
                IsActive = false,
                RequiresApproval = false,
                ApprovalTier = "auto",
                Temperature = 0.2,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.TicketResolution),
                IsActive = false,
                RequiresApproval = true,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.DocumentIntelligence),
                IsActive = false,
                RequiresApproval = true,
                ApprovalTier = "elevated",
                Temperature = 0.2,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.SalesCoach),
                IsActive = false,
                RequiresApproval = false,
                ApprovalTier = "auto",
                Temperature = 0.5,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.MeetingIntelligence),
                IsActive = false,
                RequiresApproval = false,
                ApprovalTier = "auto",
                Temperature = 0.4,
            ...
            new AIAgent
            {
                ...
                AgentType = nameof(AgentType.ConversationIntelligence),
                IsActive = false,
                RequiresApproval = false,
                ApprovalTier = "auto",
                Temperature = 0.3,
