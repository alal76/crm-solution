...
public class DbSeed
{
    ...
    private static async Task SeedSystemSettingsAsync(CrmDbContext context)
    {
        ...
        var defaultNavConfig = @"{
            ""navItems"":[{""id"":""dashboard"",""order"":0,""visible"":true,""category"":""main""},
                ...
                {""id"":""relationships"",""order"":4,""visible"":true,""category"":""main""},
                {""id"":""leads"",""order"":5,""visible"":true,""category"":""sales""},
                {""id"":""opportunities"",""order"":6,""visible"":true,""category"":""sales""},
                {""id"":""products"",""order"":7,""visible"":true,""category"":""sales""},
                {""id"":""services"",""order"":8,""visible"":true,""category"":""support""},
                {""id"":""service-requests"",""order"":9,""visible"":true,""category"":""support""},
                {""id"":""campaigns"",""order"":10,""visible"":true,""category"":""sales""},
                {""id"":""campaign-execution"",""order"":11,""visible"":true,""category"":""sales""},
                {""id"":""quotes"",""order"":12,""visible"":true,""category"":""sales""},
                {""id"":""my-queue"",""order"":13,""visible"":true,""category"":""productivity""},
                {""id"":""activities"",""order"":14,""visible"":true,""category"":""productivity""},
                {""id"":""notes"",""order"":15,""visible"":true,""category"":""productivity""},
                {""id"":""communications"",""order"":16,""visible"":true,""category"":""productivity""},
                {""id"":""interactions"",""order"":17,""visible"":true,""category"":""productivity""},
                {""id"":""about"",""order"":18,""visible"":true,""category"":""info""},
                {""id"":""help"",""order"":19,""visible"":true,""category"":""info""},
                {""id"":""licenses"",""order"":20,""visible"":true,""category"":""info""},
                {""id"":""workflows"",""order"":21,""visible"":true,""category"":""admin""},
                {""id"":""channel-settings"",""order"":22,""visible"":true,""category"":""admin""},
                {""id"":""settings"",""order"":23,""visible"":true,""category"":""admin""}],
    ...
    private static List<ModuleFieldConfiguration> GetDefaultCustomerFields(DateTime now)
    {
        return new List<ModuleFieldConfiguration>
        {
            ...
            new() { ModuleName = "Customers", FieldName = "salutation", FieldLabel = "Salutation", FieldType = "select", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 10, IsEnabled = true, IsRequired = false, GridSize = 2, Options = "Mr.,Mrs.,Ms.,Dr.,Prof.", CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "firstName", FieldLabel = "First Name", FieldType = "text", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 11, IsEnabled = true, IsRequired = false, GridSize = 4, CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "lastName", FieldLabel = "Last Name", FieldType = "text", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 12, IsEnabled = true, IsRequired = false, GridSize = 4, CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "suffix", FieldLabel = "Suffix", FieldType = "text", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 13, IsEnabled = true, IsRequired = false, GridSize = 2, Placeholder = "Jr., III", CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "dateOfBirth", FieldLabel = "Date of Birth", FieldType = "date", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 14, IsEnabled = true, IsRequired = false, GridSize = 6, CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "gender", FieldLabel = "Gender", FieldType = "select", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 15, IsEnabled = true, IsRequired = false, GridSize = 6, Options = "Male,Female,Other,Prefer not to say", CreatedAt = now },
            
            // Organization fields (shown for all accounts)
            new() { ModuleName = "Customers", FieldName = "company", FieldLabel = "Company Name", FieldType = "text", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 20, IsEnabled = true, IsRequired = false, GridSize = 6, CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "legalName", FieldLabel = "Legal Name", FieldType = "text", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 21, IsEnabled = true, IsRequired = false, GridSize = 6, Placeholder = "Full legal entity name", CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "dbaName", FieldLabel = "DBA Name", FieldType = "text", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 22, IsEnabled = true, IsRequired = false, GridSize = 6, Placeholder = "Doing Business As", CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "taxId", FieldLabel = "Tax ID / EIN", FieldType = "text", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 23, IsEnabled = true, IsRequired = false, GridSize = 6, CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "registrationNumber", FieldLabel = "Registration Number", FieldType = "text", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 24, IsEnabled = true, IsRequired = false, GridSize = 6, CreatedAt = now },
            new() { ModuleName = "Customers", FieldName = "yearFounded", FieldLabel = "Year Founded", FieldType = "number", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 25, IsEnabled = true, IsRequired = false, GridSize = 6, CreatedAt = now },
            ...
            new() { ModuleName = "Customers", FieldName = "jobTitle", FieldLabel = "Job Title", FieldType = "text", TabIndex = 0, TabName = "Basic Info", DisplayOrder = 34, IsEnabled = true, IsRequired = false, GridSize = 6, CreatedAt = now },
