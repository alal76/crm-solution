...
namespace CRM.Infrastructure.Migrations
{
    ...
    [Migration("20260125113838_AddLocalityAndSocialMediaFollow")]
    partial class AddLocalityAndSocialMediaFollow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.Core.Entities.SystemSettings", b =>
                {
                    ...
                    b.Property<DateTime?>("DemoDataLastSeeded")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<bool>("UseDemoDatabase")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowApiCredential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorkflowApiCredentials", (string)null);
                });

            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowContextVariable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorkflowContextVariables", (string)null);
                });

            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TriggerEntityType", "Status");

                    b.ToTable("WorkflowDefinitions", (string)null);
                });

            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowDefinitionVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorkflowDefinitionVersions", (string)null);
                });

            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WorkflowEngineEvents", (string)null);
                });

            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowInstance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("ActiveStepKeys")
                        .HasMaxLength(1000)
                        .HasColumnType("varchar(1000)");
                    ...
                    b.HasIndex("Status", "CurrentStepKey", "Priority");

                    b.ToTable("WorkflowInstances", (string)null);
                });

            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VisibilityTimeoutAt");

                    b.HasIndex("WorkflowInstanceId");

                    b.HasIndex("WorkflowTaskId");

                    b.HasIndex("Status", "ScheduledAt", "Priority");

                    b.ToTable("WorkflowJobs", (string)null);
                });

            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IsEnabled", "NextTriggerAt");

                    b.ToTable("WorkflowSchedules", (string)null);
                });

            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AssignedToGroupId", "Status");

                    b.HasIndex("AssignedToUserId", "Status");

                    b.HasIndex("Status", "DueAt");

                    b.ToTable("WorkflowEngineTasks", (string)null);
                });
            ...
            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowContextVariable", b =>
                {
                    b.HasOne("CRM.Core.Entities.WorkflowEngine.WorkflowInstance", "WorkflowInstance")
                        .WithMany("ContextVariables")
            ...
            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowDefinitionVersion", b =>
                {
                    ...
                    b.HasOne("CRM.Core.Entities.WorkflowEngine.WorkflowDefinition", "WorkflowDefinition")
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowInstance", b =>
                {
                    b.HasOne("CRM.Core.Entities.User", "StartedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowJob", b =>
                {
                    ...
                    b.HasOne("CRM.Core.Entities.WorkflowEngine.WorkflowTask", "WorkflowTask")
                        .WithMany()
            ...
            modelBuilder.Entity("CRM.Core.Entities.WorkflowEngine.WorkflowTask", b =>
                {
                    ...
                    b.HasOne("CRM.Core.Entities.User", "ClaimedByUser")
                        .WithMany()
