...
{
    /// <inheritdoc />
    public partial class ContactInfoDataNormalization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                        // Customers -> Addresses / ContactDetails / SocialAccounts + ContactInfoLinks (idempotent)
                        ...
                        // Accounts -> Billing address & billing contact (idempotent)
                        migrationBuilder.Sql(@"
                                INSERT INTO Addresses (Label, Line1, Line2, City, State, PostalCode, Country, IsPrimary, Notes, CreatedAt, IsDeleted)
                        ...
                        // Contacts -> primary address, email, phone, socials (idempotent)
                        migrationBuilder.Sql(@"
                                INSERT INTO Addresses (Label, Line1, Line2, City, State, PostalCode, Country, IsPrimary, Notes, CreatedAt, IsDeleted)
                        ...
                        // Leads -> primary email/phone/social (idempotent)
                        migrationBuilder.Sql(@"
                                INSERT INTO ContactDetails (DetailType, Value, Label, IsPrimary, Notes, CreatedAt, IsDeleted)
        ...
        {
            // Remove migrated contact info rows (safe-guard: only rows with migration notes)
            migrationBuilder.Sql(@"
