...
{
    public string BaseUrl { get; set; } = "http://localhost:11434";  // Ollama default // NOSONAR - S5332: internal container-to-container URL, HTTPS not applicable in Docker bridge network
