...
// This is the Algolia implementation of ISearchPort.
// Provides fast, typo-tolerant full-text search using Algolia Search API.
// Compatible with Algolia.Search SDK v7.x
