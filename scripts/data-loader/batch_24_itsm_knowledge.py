...
def run(api: ApiClient, log: RunLogger) -> None:
    ...
    api.get("/api/itsm/knowledge/search?query=VPN")
    api.get("/api/itsm/knowledge/search?query=Active+Directory")
    api.get("/api/itsm/knowledge/search?query=Kubernetes")
    api.get("/api/itsm/knowledge/search?query=backup")
