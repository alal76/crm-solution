...
CRM_PASSWORD="${CRM_PASSWORD:?Set CRM_PASSWORD}"
CRM_READONLY_USER="${CRM_READONLY_USER:-crm_readonly}"
CRM_READONLY_PASSWORD="${CRM_READONLY_PASSWORD:?Set CRM_READONLY_PASSWORD}"
MONITOR_USER="${MONITOR_USER:-proxysql_monitor}"
MONITOR_PASSWORD="${MONITOR_PASSWORD:?Set MONITOR_PASSWORD}"
