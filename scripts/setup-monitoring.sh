...
UPTIME_KUMA_ADMIN_PASS="${UPTIME_KUMA_ADMIN_PASS:?ERROR: Set UPTIME_KUMA_ADMIN_PASS environment variable}"
PORTAINER_ADMIN_USER="${PORTAINER_ADMIN_USER:-admin}"
PORTAINER_ADMIN_PASS="${PORTAINER_ADMIN_PASS:?ERROR: Set PORTAINER_ADMIN_PASS environment variable}"
