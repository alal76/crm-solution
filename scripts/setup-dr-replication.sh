...
# Configuration
# ---------------------------------------------------------------------------
PRIMARY_HOST="${PRIMARY_HOST:-192.168.0.9}"
DR_HOST="${DR_HOST:-192.168.0.50}"    # Set to your DR server IP
...
DR_REPL_PASSWORD="${DR_REPL_PASSWORD:-ReplDR@Dev2024}"
...
PG_REPL_PASSWORD="${PG_REPL_PASSWORD:-ReplDR@Dev2024}"

# Redis
PRIMARY_REDIS_PORT="${PRIMARY_REDIS_PORT:-6379}"
DR_REDIS_PORT="${DR_REDIS_PORT:-6379}"
REDIS_PASSWORD="${REDIS_PASSWORD:-RedisPass@Dev2024}"
