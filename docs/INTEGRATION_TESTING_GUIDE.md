...
- [SOLUTION_CONTEXT.md](../SOLUTION_CONTEXT.md) — Solution architecture
- [SOLUTION_GAPS_REMEDIATION_PLAN.md](SOLUTION_GAPS_REMEDIATION_PLAN.md) — Test coverage gaps (Phase 10.10, 11.11)
