...
- 🏢 **Monolithic Mode** - Perfect for startups and small teams. Deploy everything in minutes with a single container.
- 🌐 **Microservices Mode** - Scale independently with 8 specialized services, each optimized for its domain.
- 🔄 **Seamless Migration** - Start simple, scale when needed—no major rewrites required.

### **Enterprise Features, Startup Agility**

We've packed enterprise-grade capabilities without the enterprise-grade complexity:

- **Multi-tenant Architecture** - Support multiple organizations with data isolation
- **Real-time Collaboration** - SignalR-powered live updates and concurrent editing
- **AI-Powered Intelligence** - Integrated LLM support (OpenAI, Anthropic, and more)
- **Advanced Deduplication** - Fuzzy matching with Levenshtein and Soundex algorithms
- **Comprehensive Workflow Engine** - Visual designer with conditional logic and approval flows
- **Multi-Database Support** - MariaDB, PostgreSQL, SQL Server—your choice
...
│  ├─ Single Deployment          ├─ 8 Independent Services     │
│  ├─ 30-second Build            ├─ 2-5s Per Service           │
│  ├─ Perfect for SMBs           ├─ Scales Horizontally        │
│  └─ Docker/K8s Ready           └─ Kubernetes Native          │
│                                                               │
└─────────────────────────────────────────────────────────────┘
```
...
- 🎨 **Material-UI (MUI) v5** - Beautiful, accessible components
...
| Domain | Capabilities |
|--------|-------------|
| **Customer Management** | 360° customer view, lifecycle tracking, relationship mapping |
| **Sales Pipeline** | Visual pipeline, forecasting, win/loss analysis, quote management |
| **Marketing Automation** | Multi-channel campaigns, A/B testing, lead scoring, ROI tracking |
| **Service Desk** | Ticketing, SLA tracking, escalation, resolution management |
| **Workflow Engine** | Visual designer, approval workflows, automated tasks |
| **Analytics & Reports** | Customizable dashboards, KPIs, sales forecasting |

### **🚀 Advanced Capabilities**

- **🤖 AI Integration** - LLM provider framework for intelligent features
- **🔍 Smart Deduplication** - Real-time duplicate detection with configurable rules
- **🔄 Real-time Updates** - Multi-user concurrent editing with conflict resolution
- **📱 Responsive Design** - Works flawlessly on desktop, tablet, and mobile
- **🌍 Multi-Database** - Your choice of MariaDB, PostgreSQL, or SQL Server
- **🔐 Enterprise Security** - JWT auth, RBAC, security headers, rate limiting

### **📊 Scale & Performance**

- **89 Database Tables** - Comprehensive data model
